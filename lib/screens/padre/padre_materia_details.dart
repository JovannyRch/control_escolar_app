...
class PadreMateriaDetails extends StatefulWidget {
  PadreMateriaDetails({Key key}) : super(key: key);

  @override
  _PadreMateriaDetailsState createState() => _PadreMateriaDetailsState();
}
...
class _PadreMateriaDetailsState extends State<PadreMateriaDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "Matematicas 2", subtitle: "", actions: [
        Container(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _calificacionTile("Cuarto parcial", 9.9),
            _calificacionTile("Quinto parcial", 8.5),
            _calificacionTile("Sexto parcial", 10.0),
            SizedBox(height: 25.0),
